 ...
 */
function hook_devportal_api_reference_fields(\Drupal\devportal_api_reference\ReferenceInterface $type, \stdClass $doc, \Drupal\file\FileInterface $file, ?\Symfony\Component\HttpFoundation\Request $request = NULL): array {
  ...
  return [
    ...
    'field_tags' => array_filter(array_map(static function (stdClass $tag): array {
